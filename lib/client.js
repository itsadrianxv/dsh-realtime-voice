...
`;
		...
		var voice_module_css_default = {
			...
			"overlayCollapsed": "_77KAyq_overlayCollapsed",
		...
		function VoiceOverlay({ useVoice, useSessions, end, toggleMute, cancelResponse, openSession }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
				className: `${voice_module_css_default.overlay} ${collapsed ? voice_module_css_default.overlayCollapsed : ""}`,
				"aria-label": "实时语音通话",
		...
		function VoiceSettingsCard({ useVoiceModelSettings, selectModel, saveApiKey }) {
