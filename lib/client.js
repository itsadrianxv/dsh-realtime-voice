window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const VOICE_WEB_CLIENT_VERSION = "0.1.0-alpha.9";
...
`;
		...
		//#endregion
		//#region \0dsh-voice-css:C:\temp\dsh-realtime-voice\src\client\voice.module.css.mjs
		const css = ".eht49a_callButton{color:#fff;background:var(--dsw-alias-button-info-fill,#3964fe);cursor:pointer;border:0;border-radius:999px;flex:none;order:100;place-items:center;width:34px;height:34px;padding:0;transition:color .12s,background .12s,transform .12s,box-shadow .12s;display:inline-grid;transform:translateY(-2px)}.eht49a_callButton:hover{background:var(--dsw-alias-button-info-hover,#2f55dc)}.eht49a_callButton:active{transform:translateY(-2px)scale(.94)}.eht49a_callButton:disabled{color:color-mix(in srgb, currentColor 48%, transparent);background:color-mix(in srgb, var(--dsw-alias-surface-secondary,#eef0f5) 90%, transparent);cursor:not-allowed;box-shadow:none}.eht49a_callButtonActive{color:var(--dsw-alias-button-danger-text,#fff);background:var(--dsw-alias-button-danger-fill,#e5484d);box-shadow:0 0 0 4px color-mix(in srgb, var(--dsw-alias-button-danger-fill,#e5484d) 18%, transparent)}.eht49a_icon{fill:none;stroke:currentColor;stroke-width:1.55px;stroke-linecap:round;stroke-linejoin:round;width:17px;height:17px}.eht49a_stopGlyph{background:currentColor;border-radius:2px;width:8px;height:8px}.eht49a_overlay{border:1px solid var(--dsw-alias-border-subtle);width:min(372px,100vw - 40px);max-height:min(620px,100vh - 24px);color:var(--dsw-alias-text-primary);background:color-mix(in srgb, var(--dsw-alias-surface-primary) 94%, transparent);backdrop-filter:blur(18px);will-change:left, top;border-radius:18px;flex-direction:column;padding:16px;display:flex;position:fixed;top:72px;right:20px;overflow:hidden;box-shadow:0 18px 56px #0000002e}.eht49a_overlayError{gap:14px;width:min(372px,100vw - 40px)}.eht49a_dragHandle,.eht49a_voiceOrb{touch-action:none;user-select:none;cursor:grab}.eht49a_dragging,.eht49a_dragging .eht49a_dragHandle{cursor:grabbing;transition:none!important}.eht49a_voiceOrb{border:1px solid color-mix(in srgb, var(--dsw-alias-brand-primary,#3964fe) 45%, transparent);background:color-mix(in srgb, var(--dsw-alias-surface-primary,#fff) 88%, transparent);width:76px;height:76px;box-shadow:0 14px 38px #00000038, 0 0 0 6px color-mix(in srgb, var(--dsw-alias-brand-primary,#3964fe) 10%, transparent);backdrop-filter:blur(18px);will-change:left, top;border-radius:50%;padding:0;position:fixed;bottom:20px;right:20px;overflow:hidden}.eht49a_voiceOrb[data-phase=speaking]{box-shadow:0 14px 38px #00000038, 0 0 0 8px color-mix(in srgb, var(--dsw-alias-brand-primary,#3964fe) 17%, transparent)}.eht49a_orbButton{border-radius:inherit;color:#fff;width:100%;height:100%;cursor:inherit;background:radial-gradient(circle at 35% 28%,#7390ff 0,#3964fe 44%,#2747c9 100%);border:0;place-content:center;gap:5px;padding:0;display:grid}.eht49a_orbWaves{justify-content:center;align-items:center;gap:3px;height:22px;display:flex}.eht49a_orbWaves i{opacity:.92;background:currentColor;border-radius:999px;width:3px;height:8px;animation:.85s ease-in-out infinite alternate eht49a_voice-wave;display:block}.eht49a_orbWaves i:nth-child(2),.eht49a_orbWaves i:nth-child(4){height:15px;animation-delay:-240ms}.eht49a_orbWaves i:nth-child(3){height:21px;animation-delay:-420ms}.eht49a_voiceOrb[data-phase=listening] .eht49a_orbWaves i,.eht49a_voiceOrb[data-phase=agent-working] .eht49a_orbWaves i{animation-duration:1.25s}.eht49a_orbTime{font-variant-numeric:tabular-nums;opacity:.86;font-size:10px}@keyframes eht49a_voice-wave{0%{opacity:.62;transform:scaleY(.55)}to{opacity:1;transform:scaleY(1.15)}}.eht49a_overlayHeader,.eht49a_controls{justify-content:space-between;align-items:center;gap:10px;display:flex}.eht49a_overlayHeader{border-radius:12px;margin:-8px -8px 0;padding:8px}.eht49a_headerActions{align-items:center;gap:8px;display:flex}.eht49a_iconButton{border:1px solid var(--dsw-alias-border-l2,var(--dsw-alias-border-subtle));width:28px;height:28px;color:var(--dsw-alias-label-secondary,var(--dsw-alias-text-secondary));background:var(--dsw-alias-bg-layer-3,var(--dsw-alias-surface-primary));cursor:pointer;border-radius:999px;font-size:20px;line-height:1}.eht49a_eyebrow{color:var(--dsw-alias-text-secondary);margin-bottom:4px;font-size:12px;font-weight:600}.eht49a_phaseLine{align-items:center;gap:7px;font-size:15px;font-weight:600;display:flex}.eht49a_liveDot{background:var(--dsw-alias-status-success,#30a46c);width:8px;height:8px;box-shadow:0 0 0 5px color-mix(in srgb, var(--dsw-alias-status-success,#30a46c) 18%, transparent);border-radius:50%}.eht49a_agentState{color:var(--dsw-alias-text-secondary);background:var(--dsw-alias-fill-subtle);border-radius:999px;padding:6px 10px;font-size:12px}.eht49a_bindingCard{border:1px solid var(--dsw-alias-border-l2,var(--dsw-alias-border-subtle));background:var(--dsw-alias-bg-layer-3,var(--dsw-alias-fill-subtle));border-radius:12px;margin-top:14px;padding:12px}.eht49a_bindingLabel,.eht49a_speakerLabel{color:var(--dsw-alias-label-tertiary,var(--dsw-alias-text-secondary));font-size:11px;font-weight:600}.eht49a_bindingTitle{color:var(--dsw-alias-label-primary,var(--dsw-alias-text-primary));text-overflow:ellipsis;white-space:nowrap;margin-top:3px;font-size:14px;font-weight:600;overflow:hidden}.eht49a_bindingMeta{color:var(--dsw-alias-label-tertiary,var(--dsw-alias-text-secondary));margin-top:5px;font-size:11px;line-height:1.45}.eht49a_returnLink{color:var(--dsw-alias-brand-primary,#3964fe);cursor:pointer;background:0 0;border:0;margin-top:8px;padding:0;font-size:12px}.eht49a_transcripts{align-content:start;gap:12px;min-height:120px;max-height:230px;margin:14px 0;padding:2px 4px 2px 2px;display:grid;overflow-y:auto}.eht49a_transcriptBlock{background:var(--dsw-alias-fill-subtle,var(--dsw-alias-bg-layer-3));border-radius:12px;gap:4px;padding:10px 12px;display:grid}.eht49a_userText,.eht49a_assistantText{margin:0;line-height:1.5}.eht49a_userText{color:var(--dsw-alias-text-secondary);font-size:13px}.eht49a_assistantText{font-size:15px}.eht49a_agentSummary{border-left:3px solid var(--dsw-alias-brand-primary,#3964fe);max-height:120px;color:var(--dsw-alias-label-secondary,var(--dsw-alias-text-secondary));background:var(--dsw-alias-bg-layer-2,var(--dsw-alias-fill-subtle));border-radius:0 10px 10px 0;gap:5px;margin-bottom:12px;padding:10px 12px;font-size:12px;line-height:1.5;display:grid;overflow-y:auto}.eht49a_interactionCard{border:1px solid color-mix(in srgb, var(--dsw-alias-status-warning,#f2a20c) 55%, var(--dsw-alias-border-subtle));background:color-mix(in srgb, var(--dsw-alias-status-warning,#f2a20c) 8%, var(--dsw-alias-surface-primary));border-radius:12px;gap:8px;max-height:230px;margin-bottom:12px;padding:11px 12px;font-size:12px;display:grid;overflow-y:auto}.eht49a_interactionTitle{font-size:13px;font-weight:600}.eht49a_interactionDetail{color:var(--dsw-alias-label-secondary,var(--dsw-alias-text-secondary));margin:0;line-height:1.45}.eht49a_interactionActions{justify-content:flex-end;gap:8px;display:flex}.eht49a_allowButton,.eht49a_rejectButton{font:inherit;cursor:pointer;border:1px solid #0000;border-radius:999px;padding:6px 11px}.eht49a_allowButton{color:#fff;background:var(--dsw-alias-button-info-fill,#3964fe)}.eht49a_rejectButton{color:var(--dsw-alias-text-primary);border-color:var(--dsw-alias-border-subtle);background:var(--dsw-alias-surface-primary)}.eht49a_questionBlock{border-top:1px solid var(--dsw-alias-border-subtle);gap:6px;padding-top:7px;display:grid}.eht49a_questionOption{cursor:pointer;align-items:flex-start;gap:7px;line-height:1.4;display:flex}.eht49a_questionCustom{border:1px solid var(--dsw-alias-border-subtle);min-width:0;height:32px;color:var(--dsw-alias-text-primary);background:var(--dsw-alias-surface-primary);font:inherit;border-radius:8px;padding:0 9px}.eht49a_controls{border-top:1px solid var(--dsw-alias-border-l2,var(--dsw-alias-border-subtle));flex-wrap:wrap;justify-content:flex-end;margin-top:auto;padding-top:12px}.eht49a_secondaryButton,.eht49a_endButton{border:1px solid var(--dsw-alias-border-subtle);color:var(--dsw-alias-text-primary);background:var(--dsw-alias-surface-primary);cursor:pointer;border-radius:999px;padding:7px 12px}.eht49a_endButton{color:#fff;background:var(--dsw-alias-button-danger-fill,#e5484d);border-color:#0000}.eht49a_inlineError,.eht49a_errorText{color:var(--dsw-alias-status-danger-text,#d13438);font-size:13px}.eht49a_errorText{flex:1}.eht49a_settingsCard{border:1px solid var(--dsw-alias-border-l2,var(--dsw-alias-border-subtle));color:var(--dsw-alias-label-primary,var(--dsw-alias-text-primary));background:var(--dsw-alias-bg-layer-3,var(--dsw-alias-surface-primary));border-radius:12px;list-style:none}.eht49a_settingsCardHeader{align-items:center;gap:12px;padding:14px 16px;display:flex}.eht49a_settingsCardIcon{color:#fff;background:var(--dsw-alias-button-info-fill,#3964fe);border-radius:10px;flex:none;place-items:center;width:34px;height:34px;display:grid}.eht49a_settingsCardHeading{gap:3px;min-width:0;display:grid}.eht49a_settingsCardHeading strong{font-size:15px}.eht49a_settingsCardHeading span{color:var(--dsw-alias-label-tertiary,var(--dsw-alias-text-secondary));font-size:13px;line-height:1.45}.eht49a_settingsCardBody{border-top:1px solid var(--dsw-alias-border-l2,var(--dsw-alias-border-subtle));margin:0 16px;padding:14px 0 16px}.eht49a_settingsLabel{margin-bottom:9px;font-size:13px;font-weight:600}.eht49a_modelSwitch{grid-template-columns:repeat(2,minmax(0,1fr));gap:10px;display:grid}.eht49a_modelChoice{border:1px solid var(--dsw-alias-border-l2,var(--dsw-alias-border-subtle));min-width:0;color:inherit;background:var(--dsw-alias-bg-layer-2,transparent);text-align:left;cursor:pointer;border-radius:10px;padding:11px 34px 11px 12px;position:relative}.eht49a_modelChoiceSelected{border-color:var(--dsw-alias-brand-primary,#3964fe);box-shadow:0 0 0 1px var(--dsw-alias-brand-primary,#3964fe)}.eht49a_modelChoice:disabled{opacity:.55;cursor:default}.eht49a_modelChoiceTitle,.eht49a_modelChoiceDetail{display:block}.eht49a_modelChoiceTitle{font-size:14px;font-weight:600}.eht49a_modelChoiceDetail{color:var(--dsw-alias-label-tertiary,var(--dsw-alias-text-secondary));margin-top:4px;font-size:11px;line-height:1.4}.eht49a_radioDot{border:1px solid var(--dsw-alias-label-dimmed,#8a8f98);border-radius:50%;width:12px;height:12px;position:absolute;top:13px;right:12px}.eht49a_modelChoiceSelected .eht49a_radioDot{border:4px solid var(--dsw-alias-brand-primary,#3964fe)}.eht49a_settingsHint,.eht49a_settingsError{color:var(--dsw-alias-label-tertiary,var(--dsw-alias-text-secondary));margin:9px 0 0;font-size:12px;line-height:1.5}.eht49a_settingsSubsection{border-top:1px solid var(--dsw-alias-border-l2,var(--dsw-alias-border-subtle));margin-top:14px;padding-top:14px}.eht49a_settingsError{color:var(--dsw-alias-label-error,#d13438)}.eht49a_credentialSection{border-top:1px solid var(--dsw-alias-border-l2,var(--dsw-alias-border-subtle));margin-top:14px;padding-top:14px}.eht49a_credentialStatus{color:var(--dsw-alias-label-tertiary,var(--dsw-alias-text-secondary));align-items:center;gap:7px;margin-bottom:9px;font-size:12px;display:flex}.eht49a_credentialDot{background:var(--dsw-alias-label-error,#d13438);border-radius:50%;flex:none;width:7px;height:7px}.eht49a_credentialStatus[data-configured] .eht49a_credentialDot{background:var(--dsw-alias-status-success,#30a46c);box-shadow:0 0 0 3px color-mix(in srgb, var(--dsw-alias-status-success,#30a46c) 14%, transparent)}.eht49a_credentialInputRow{gap:8px;display:flex}.eht49a_credentialInput{border:1px solid var(--dsw-alias-border-l2,var(--dsw-alias-border-subtle));min-width:0;height:36px;color:var(--dsw-alias-label-primary,var(--dsw-alias-text-primary));background:var(--dsw-alias-bg-layer-2,var(--dsw-alias-surface-primary));font:inherit;border-radius:8px;outline:none;flex:1;padding:0 11px;font-size:13px}.eht49a_credentialInput:focus{border-color:var(--dsw-alias-brand-primary,#3964fe)}.eht49a_credentialSave{color:#fff;background:var(--dsw-alias-button-info-fill,#3964fe);height:36px;font:inherit;cursor:pointer;border:0;border-radius:8px;flex:none;padding:0 13px;font-size:13px}.eht49a_credentialSave:disabled,.eht49a_credentialInput:disabled{opacity:.5;cursor:default}@media (width<=1199px){.eht49a_overlay{border-radius:16px;width:min(420px,100vw - 24px);max-height:min(560px,100vh - 24px);padding:14px;top:auto;bottom:12px;right:12px}.eht49a_voiceOrb{bottom:12px;right:12px}.eht49a_controls{justify-content:stretch}.eht49a_secondaryButton,.eht49a_endButton{flex:1}}@media (width<=520px){.eht49a_modelSwitch{grid-template-columns:1fr}}";
		...
		var voice_module_css_default = {
			"questionOption": "eht49a_questionOption",
			"modelChoiceSelected": "eht49a_modelChoiceSelected",
			"credentialInputRow": "eht49a_credentialInputRow",
			"secondaryButton": "eht49a_secondaryButton",
			"bindingCard": "eht49a_bindingCard",
			"callButtonActive": "eht49a_callButtonActive",
			"settingsError": "eht49a_settingsError",
			"voice-wave": "eht49a_voice-wave",
			"stopGlyph": "eht49a_stopGlyph",
			"bindingTitle": "eht49a_bindingTitle",
			"settingsSubsection": "eht49a_settingsSubsection",
			"overlayHeader": "eht49a_overlayHeader",
			"interactionTitle": "eht49a_interactionTitle",
			"agentSummary": "eht49a_agentSummary",
			"iconButton": "eht49a_iconButton",
			"interactionCard": "eht49a_interactionCard",
			"modelSwitch": "eht49a_modelSwitch",
			"credentialSection": "eht49a_credentialSection",
			"overlayError": "eht49a_overlayError",
			"interactionActions": "eht49a_interactionActions",
			"inlineError": "eht49a_inlineError",
			"orbButton": "eht49a_orbButton",
			"settingsCardHeading": "eht49a_settingsCardHeading",
			"voiceOrb": "eht49a_voiceOrb",
			"modelChoiceDetail": "eht49a_modelChoiceDetail",
			"radioDot": "eht49a_radioDot",
			"credentialStatus": "eht49a_credentialStatus",
			"controls": "eht49a_controls",
			"userText": "eht49a_userText",
			"dragging": "eht49a_dragging",
			"errorText": "eht49a_errorText",
			"settingsCardHeader": "eht49a_settingsCardHeader",
			"settingsHint": "eht49a_settingsHint",
			"bindingLabel": "eht49a_bindingLabel",
			"interactionDetail": "eht49a_interactionDetail",
			"credentialSave": "eht49a_credentialSave",
			"overlay": "eht49a_overlay",
			"returnLink": "eht49a_returnLink",
			"agentState": "eht49a_agentState",
			"settingsCardBody": "eht49a_settingsCardBody",
			"eyebrow": "eht49a_eyebrow",
			"settingsLabel": "eht49a_settingsLabel",
			"phaseLine": "eht49a_phaseLine",
			"settingsCard": "eht49a_settingsCard",
			"liveDot": "eht49a_liveDot",
			"credentialInput": "eht49a_credentialInput",
			"orbWaves": "eht49a_orbWaves",
			"questionCustom": "eht49a_questionCustom",
			"questionBlock": "eht49a_questionBlock",
			"endButton": "eht49a_endButton",
			"settingsCardIcon": "eht49a_settingsCardIcon",
			"assistantText": "eht49a_assistantText",
			"allowButton": "eht49a_allowButton",
			"dragHandle": "eht49a_dragHandle",
			"icon": "eht49a_icon",
			"orbTime": "eht49a_orbTime",
			"credentialDot": "eht49a_credentialDot",
			"transcripts": "eht49a_transcripts",
			"headerActions": "eht49a_headerActions",
			"callButton": "eht49a_callButton",
			"speakerLabel": "eht49a_speakerLabel",
			"modelChoice": "eht49a_modelChoice",
			"modelChoiceTitle": "eht49a_modelChoiceTitle",
			"bindingMeta": "eht49a_bindingMeta",
			"rejectButton": "eht49a_rejectButton",
			"transcriptBlock": "eht49a_transcriptBlock"
		};
		//#endregion
