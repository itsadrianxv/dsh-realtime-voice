...
const VOICE_WEB_CLIENT_VERSION = "0.1.0-alpha.9-research.3";
...
//#endregion
export { AUDIO_CHANNELS, AUDIO_HEADER_BYTES, AudioFrameCodec, AudioFrameFlags, AudioFrameKind, INPUT_SAMPLE_RATE, OUTPUT_SAMPLE_RATE, VOICE_PROTOCOL, VOICE_PROTOCOL_VERSION, VOICE_ROUTE, VOICE_STATUS_ROUTE, VOICE_WEB_CLIENT_VERSION, decodeAudioFrame, encodeAudioFrame, isVoiceClientControl };
